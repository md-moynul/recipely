      ...
      <nav className="sticky top-0 z-40 w-full border-b border-[#EAE0D3] bg-[#FFF9F2]/80 backdrop-blur-lg dark:border-[#3A332A] dark:bg-[#1A1714]/80">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={openCart}
              className="relative flex h-10 w-10 items-center justify-center rounded-xl border border-[#EAE0D3] bg-white/80 text-[#2B2420] shadow-2xs backdrop-blur-xs transition-all hover:border-[#E85D3D] hover:text-[#E85D3D] dark:border-[#3A332A] dark:bg-[#252019]/80 dark:text-[#F4EDE4] dark:hover:border-[#FF7A52] dark:hover:text-[#FF7A52] cursor-pointer"
              aria-label="View shopping cart"
            >
              <CartIcon className="w-[19px] h-[19px]" />
              {totalCount > 0 && (
                <span className="absolute -top-1.5 -right-1.5 flex h-5 min-w-[20px] items-center justify-center rounded-full bg-[#E85D3D] px-1 text-[11px] font-bold text-white shadow-sm ring-2 ring-white dark:ring-[#1A1714] animate-in zoom-in-50 duration-200">
                  {totalCount}
                </span>
              )}
            </button>
