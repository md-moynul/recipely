...
// Kept your exact thematic classes from the add page
...
export default function EditRecipeForm({ id }) {
  ...
  // Resolve the recipe details on mount or ID switch
  useEffect(() => {
    (async () => {
      setRecipeId(id);
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
              ...
              >
                ...
                <Select.Popover className="bg-white dark:bg-[#252019]">
                  <ListBox>
                    {CATEGORIES.map((cat) => (
                      <ListBox.Item key={cat} id={cat} className="text-[#2B2420] dark:text-[#F4EDE4]">
                        <Label>{cat}</Label>
                      </ListBox.Item>
                    ))}
                  </ListBox>
                ...
                <Select.Popover className="bg-white dark:bg-[#252019]">
                  <ListBox>
                    {CUISINES.map((cuisine) => (
                      <ListBox.Item key={cuisine} id={cuisine} className="text-[#2B2420] dark:text-[#F4EDE4]">
                        <Label>{cuisine}</Label>
                      </ListBox.Item>
                    ))}
                  </ListBox>
                ...
                <Select.Popover className="bg-white dark:bg-[#252019]">
                  <ListBox>
                    {DIFFICULTIES.map((level) => (
                      <ListBox.Item key={level} id={level} className="text-[#2B2420] dark:text-[#F4EDE4]">
                        <Label>{level}</Label>
                      </ListBox.Item>
                    ))}
                  </ListBox>
