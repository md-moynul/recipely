...
function StatusBadge({ isBlocked }) {
    return (
        <span
            className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${isBlocked
                    ...
                    {users.map((u) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <td className="px-4 py-3">
                                    <span className={`text-sm text-[#6B6155] dark:text-[#B8AFA2] ${u.isPremium ? "text-green-600 flex items-center gap-1" : "text-red-600"}`}>
